...
public class ArchieveCustomerTC_13 extends SuperTestScript{

	@Test
	public void testArchieveCustomerTC_13() throws InterruptedException
	{
		String username = ExcelOperation.readData("TC_02", 1, 0);
    	String password = ExcelOperation.readData("TC_02", 1, 1);
    	String ExpectedResult = ExcelOperation.readData("TC_13", 1, 1);
    	String customername = ExcelOperation.readData("TC_13", 1, 0);
    	//PAGE OBJECT MODEL
        ...
        edit.clickOnArchieveThisCustomerButton();
        
        String ActualResult =  edit.retriveSuccessMessage();
        ExcelOperation.writeData("TC_13", 1, 2, ActualResult);
        
        String status = ValidationOperation.verify(ExpectedResult, ActualResult);
        ExcelOperation.writeData("TC_13", 1, 3, status);
